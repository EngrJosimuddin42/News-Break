...
class SocialsReportSheet extends GetView<SocialsController> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      socialController.openReport(contentId, contentType);
    });
    ...
    return Container(
      ...
      child: Obx(() => socialController.isReportSubmitted.value
          ? ReportSuccess()
          : _buildSelectReason(context, socialController, notifController)),
    );
  }

  Widget _buildSelectReason(
      BuildContext context,
      SocialInteractionController socialController,
      ...
      child: Column(
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemCount: notifController.reportReasons.length,
            itemBuilder: (_, i) {
              final reason = notifController.reportReasons[i];
