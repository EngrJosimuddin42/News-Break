...
class ReactionsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String loginUserName = Get
        .find<AuthController>()
        .user
        .value
        ?.name ?? '';
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          int index = controller.reelsList.indexWhere((r) =>
                          r.id == reel.id);
                          if (index != -1) {
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Icon(
                                Icons.thumb_up, color: AppColors.surface,
                                size: 10),
                          ),
                        ],
                      ),
                      ...
                      GestureDetector(
                        onTap: () {
                          int indexInMainList = controller.reelsList.indexWhere(
                                  (reel) =>
                              reel.id.toString() == reaction['id'].toString());
                          if (indexInMainList != -1) {
                            controller.updatePage(indexInMainList);
                            Get.back();
                          } else if (reaction['videoUrl'] != null &&
                              reaction['videoUrl'] != "") {
                            Get.to(() =>
